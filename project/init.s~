...
# 76 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,78,.LM27-.LFBB3
.LM27:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,79,.LM28-.LFBB3
.LM28:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC3, %edi
	.stabn	68,0,78,.LM29-.LFBB3
.LM29:
	movl	$24, 8(%rsp)
	movl	$48, 12(%rsp)
	movq	%rax, 16(%rsp)
...
.LM34:
	...
	movaps	%xmm7, 192(%rsp)
.L16:
	.stabn	68,0,96,.LM35-.LFBB4
.LM35:
	leaq	224(%rsp), %rax
	.stabn	68,0,93,.LM36-.LFBB4
.LM36:
	movq	%rdx, %rbx
	.stabn	68,0,97,.LM37-.LFBB4
.LM37:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC5, %edi
...
.LM39:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,98,.LM40-.LFBB4
.LM40:
	leaq	8(%rsp), %rsi
	movq	%rbx, %rdi
	call	vcprintf
	.stabn	68,0,99,.LM41-.LFBB4
.LM41:
	movl	$.LC4, %edi
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,101,.LM42-.LFBB4
.LM42:
	addq	$208, %rsp
	.cfi_def_cfa_offset 16
	popq	%rbx
